...
**Team Leader:** Pavithra S

**Team Members:**
- Rahima Banu
- Pavithra S
- Potnuru Meher Paramesh
- Bhaskar Tripathi
...
This forecasting page uses Power BI's built-in time-series forecasting model to predict expected sales for the next 30 days based on historical sales trends.

![Sales Forecast Dashboard](Forecasting.png)
